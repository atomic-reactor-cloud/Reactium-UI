    ...
    api: [
        {
            ...
            description:
                '<p>Before index.html template render for SPA template (both Front-end and Server-Side Render). Defines React bind pointes in markup.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'AppBindings',
                            description:
                                '<p>Server app binding registry object.</p>',
                        },
                    ],
                    binding: [
                        {
                            ...
                            field: 'component',
                            description:
                                '<p>string name of component to bind directly if possible (must be in a webpack search context in reactium-config)</p>',
                        },
                        {
                            group: 'binding',
                            type: 'String',
                            ...
                            field: 'markup',
                            description:
                                '<p>ordinary markup that React will use to bind the app.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Before index.html template render for SPA template (both Front-end and Server-Side Render). Defines window globals to be defined in template. Will also define global for nodejs (useful for Server-Side-Rendering).</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'AppGlobals',
                            description:
                                '<p>Server app globals registry object.</p>',
                        },
                    ],
                    global: [
                        {
                            ...
                            field: 'name',
                            description:
                                '<p>The property name that will be added to window (for browser) or global (for nodejs).</p>',
                        },
                        {
                            group: 'global',
                            type: 'Mixed',
                            ...
                            field: 'value',
                            description:
                                '<p>any javascript value that can be serialized for use in a script tag</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Before index.html template render for SPA template (both Front-end and Server-Side Render). Defines html head tags (exluding stylesheet). Use this hook to register/unregister <head> tags as strings. Note: if using Server Side Render and react-helmet, this is often unnecessary to do.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'AppHeaders',
                            description:
                                '<p>Server app header registry object.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Before index.html template render for SPA template (both Front-end and Server-Side Render). Defines javascript files to be loaded.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'AppScripts',
                            description:
                                '<p>Server app scripts registry object.</p>',
                        },
                    ],
                    script: [
                        {
                            ...
                            defaultValue: 'true',
                            description:
                                '<p>Place the script tag in the footer if true</p>',
                        },
                        {
                            group: 'script',
                            type: 'Boolean',
                            ...
                            defaultValue: 'false',
                            description:
                                '<p>Place the script tag above the body if true</p>',
                        },
                        {
                            group: 'script',
                            type: 'String',
        ...
        },
        {
            ...
            description:
                '<p>Before index.html template render for SPA template (both Front-end and Server-Side Render). Defines snippets of code to be added to document in their entirety.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'AppSnippets',
                            description:
                                '<p>Server app snippets registry object.</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Before index.html template render for SPA template (both Front-end and Server-Side Render). Defines css files to be loaded.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            description:
                                '<p>Server app styles registry object.</p>',
                        },
                    ],
                    stylesheet: [
                        {
                        ...
                        },
                        {
                            ...
                            field: 'sizes',
                            description:
                                '<p>the sizes attribute if rel=icon</p>',
                        },
                        {
                            group: 'stylesheet',
                            type: 'String',
                        ...
                        },
                        {
                            ...
                            field: 'when',
                            description:
                                '<p>callback passed the request object, and returns true or false if the css should be included</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Used to register or unregister express middleware.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'Middleware',
                            description:
                                '<p>Server express middleware registry object.</p>',
                        },
                    ],
                    middleware: [
                        {
                    ...
                    middlware: [
                        {
                            ...
                            field: 'use',
                            description:
                                '<p>the express middleware function.</p>',
                        },
                        {
                            group: 'middlware',
                            type: 'Number',
                            ...
                            field: 'order',
                            description:
                                '<p>the loading order of the middleware</p>',
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                '<p>Before index.html template render for SPA template (both Front-end and Server-Side Render). Called after other Server hooks.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            description:
                '<p>Before index.html template render for SPA template (both Front-end and Server-Side Render). Called before other Server hooks.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
        ...
        },
        {
            ...
            name: 'useRefs',
            description:
                '<p>Creates a single reference object that can be managed using the <code>get</code>/<code>set</code>/<code>del</code>/<code>clear</code> functions.</p>',
            examples: [
                {
                    title: 'Usage',
                    content:
            ...
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/useRefs.js',
            groupTitle: 'ReactHook',
        },
        {
            type: 'ReactHook',
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: 'callback',
                            description:
                                '<p>async function (or returning promise) that will be called when the hook is run. The hook callback will receive any parameters provided to Hook.run, followed by a context object (passed by reference to each callback).</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Integer',
                ...
                fields: {
                    Parameter: [
                        ...
                        },
                        {
                            ...
                            field: 'callback',
                            description:
                                '<p>function returning promise that will be called when the hook is run. The hook callback will receive any parameters provided to Hook.run, followed by a context object (passed by reference to each callback).</p>',
                        },
                        {
                            group: 'Parameter',
                            type: 'Integer',
        ...
        },
        {
            ...
            name: 'Registry',
            description:
                '<p>Reactium uses a number of registry objects used to registering all sorts of objects that will be used elsewhere in the framework. New registry objects are generally instanciated as singletons on the overall SDK.</p> <p>There are many registry objects attached by default to the SDK, and developers can create new ones using <code>Utils.registryFactory()</code>.</p>',
            parameter: {
                fields: {
                    Parameter: [
                        {
                            ...
                            field: 'list',
                            description:
                                '<p>{Getter} get list of most recent (or highest order) registered objects, filtering out unregistered or banned objects.</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'registered',
                            description:
                                '<p>{Getter} get list of all historically registrated objects, even duplicates, ordered by order property of object (defaults to 100).</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'protected',
                            description:
                                '<p>{Getter} get list of protected registrations ids</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'unregistered',
                            description:
                                '<p>{Getter} get list of all existing registered objects ids that have been subsequently unregistered.</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'banned',
                            description:
                                '<p>{Getter} get list of all banned objects ids.</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'mode',
                            description:
                                '<p>{Getter} get current mode (Default Utils.Registry.MODES.HISTORY)</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'isProtected',
                            description:
                                '<p>{Method} pass the identifier of an object to see if it has been protected</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'isRegistered',
                            description:
                                '<p>{Method} pass the identifier of an object to see if it has been registered</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'isBanned',
                            description:
                                '<p>{Method} pass the identifier of an object to see if it has been banned</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'ban',
                            description:
                                '<p>{Method} pass the identifier of an object to ban. Banned objects can not be registered and will not be show in list. Useful when you have code that needs to preempt the registration of an object from code you do not control. E.g. a plugin is introducing undesireable or disabled functionality</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'cleanup',
                            description:
                                '<p>{Method} pass the identifier of an object to be purged from historical registrations (i.e. free up memory) Automatically performed in mode Utils.Registry.CLEAN</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'protect',
                            description:
                                '<p>{Method} pass the identifier of an object to protect. Protected objects can not be overridden or cleaned up.</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'register',
                            description:
                                '<p>{Method} pass an identifier and a data object to register the object. The identifier will be added if it is not already registered (but protected) and not banned.</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'unprotect',
                            description:
                                '<p>{Method} pass an identifier to unprotect an object</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'unregister',
                            description:
                                '<p>{Method} pass an identifier to unregister an object. When in HISTORY mode (default), previous registration will be retained, but the object will not be listed. In CLEAN mode, the previous registrations will be removed, unless protected.</p>',
                        },
                        {
                            group: 'Parameter',
                            optional: false,
                            field: 'flush',
                            description:
                                '<p>{Method} clear all registrations. Resets registry to newly constructed state.</p>',
                        },
                    ],
                },
            },
            version: '0.0.0',
            filename:
                'node_modules/@atomic-reactor/reactium-sdk-core/lib/utils/registry.js',
            groupTitle: 'Reactium',
        },
        {
            type: 'Function',
